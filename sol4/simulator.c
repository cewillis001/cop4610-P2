/* file: simulator.c
   $Id: simulator.c,v 1.1 2005/01/19 14:40:51 baker Exp $
   author: Ted Baker
   ...
   Edited to remove a trace statement, inducing a difference in
   stderr outputs between the baseline (sol0) and sol4
   By Caroline Willis
   February 1, 2015
